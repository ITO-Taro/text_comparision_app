...
class JobDescriptionCleaner:
    ...
    '''
    PATH = "/Users/taro/Desktop/Job_Hunting/"
    ...
    def remove_conjunc_adject(self, file):
        '''
...
class ResumeCleaner(JobDescriptionCleaner):
    ...
    def __init__(self):
        ...
        '''
        super().__init__()
        self.resume = self.__resume_reader()
...
class DocComparision(ResumeCleaner):
    ...
    def __init__(self):
        ...
        '''
        super().__init__()
        self.employers_words = self.__tup_to_dict(self.word_counted_description)
        self.my_words = self.__tup_to_dict(self.word_counted_resume)
        self.processed_data = self.__check_counts(self.employers_words, self.my_words)
        self.df = self.to_dataframe(self.processed_data)
        self.resume_text = ' '.join(self.very_clean_resume)
        self.description_text = ' '.join(self.cleaned_description)
